 ...
 class ReportController extends ControllerBase {
      ...
      */
      protected function load() {
        ...
        //   join the uses table, so we can get the entry creator's username 
      ...
      public function report() {
          ...
          $content['message'] = array(
              '#markup' => $this->t('Below is a list of all Evenet RSVPs including username, email address and the name of the event they will be attending'),
          );
          $headers = array(
              t('Name'),
              t('Event'),
